...
class WalletRechargeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('blades.admin.wallet-recharge.index', compact('pendingRequests', 'approvedRequests', 'rejectedRequests'));
    }
    ...
    public function show($id)
    {
        ...
        return view('blades.admin.wallet-recharge.show', compact('request'));
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        DB::transaction(function () use ($rechargeRequest, $admin) {
            // Update request status
            $rechargeRequest->status = 'APPROVED';
            $rechargeRequest->approved_by = $admin->id;
        ...
        return redirect()->route('admin.wallet-recharge.index')
