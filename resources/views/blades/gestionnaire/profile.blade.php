<x-allthepages-layout pageTitle="My Profile">
    <div class="space-y-6">
        ...
        <div class="rounded-lg shadow p-6" style="background-color: #F3EBDD;">
            ...
            <form action="{{ route('gestionnaire.profile.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('gestionnaire.dashboard') }}" class="rounded transition hover:opacity-90" style="background-color: #D6BFBF; color: #193948; padding: 1rem 2rem;">
