                        ...
                        <tbody>
                            @foreach($pendingRequests as $req)
                                <tr style="border-top: 1px solid rgba(0,0,0,0.1);">
                                    ...
                                    <td class="text-center text-sm" style="color: #193948; padding: 1rem 1.5rem;">{{ $req->payment_method === 'CHEQUE' ? 'Cheque' : 'Postal Transfer' }}</td>
                                    <td class="text-center text-sm" style="color: #193948; padding: 1rem 1.5rem;">{{ $req->transaction_reference ?? 'N/A' }}</td>
                                    ...
                                    <td class="text-center text-sm whitespace-nowrap" style="padding: 1rem 1.5rem;">
                                        <a href="{{ route('gestionnaire.wallet-recharge.show', $req->id) }}" class="inline-block rounded text-sm transition hover:opacity-90" style="background-color: #D6BFBF; color: #193948; padding: 0.5rem 1rem;">
                                            View Details
                                        </a>
                                    </td>
                                </tr>
