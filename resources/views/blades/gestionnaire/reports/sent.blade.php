<x-allthepages-layout pageTitle="Sent Reports">
    <div style="padding: 5px; margin: 5px;">
        <div class="stat-card" style="padding: 1.5rem; margin-bottom: 10px;">
            <h2 style="color: #193948; font-size: 1.5rem; font-weight: 700; margin-bottom: 0.5rem;">Sent Reports</h2>
            <p style="color: #36454f; font-size: 0.9rem;">Reports you sent</p>
        </div>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background-color: #193948;">
                                <th style="color: #4FADC0; padding: 1rem; text-align: center; font-size: 0.85rem; font-weight: 600;">To</th>
                            ...
                            @foreach($reports as $report)
                                <tr style="border-top: 1px solid rgba(25, 57, 72, 0.1);">
                                    <td style="color: #193948; padding: 1rem; text-align: center;">
                                        {{ $report->targetUser?->name ?? ucfirst($report->target_role ?? 'Unknown') }}
                                    </td>
                                    <td style="color: #193948; padding: 1rem; text-align: center;">
