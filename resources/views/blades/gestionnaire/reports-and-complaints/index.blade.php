    ...
    <div style="padding: 1rem;">
        <div class="stat-card" style="padding: 1rem; margin-bottom: 1rem;">
            <div style="display:flex; justify-content:space-between; flex-wrap:wrap; gap:0.8rem;">
                <div>
                    <h2 style="margin:0; color:#193948;">Operations Case Center</h2>
                    <p style="margin:0.35rem 0 0; color:#36454f;">Gestionnaire can submit and reply to complaints/reports.</p>
                </div>
                <div style="display:flex; gap:0.5rem; flex-wrap:wrap;">
                    <a href="{{ route('gestionnaire.complaints.create', ['type' => 'complaint']) }}" class="primary-button" style="background:#E76268; color:white; text-decoration:none;">Submit Complaint</a>
                    <a href="{{ route('gestionnaire.complaints.create', ['type' => 'report']) }}" class="primary-button" style="background:#10b981; color:white; text-decoration:none;">Submit Report</a>
                    <a href="{{ route('gestionnaire.complaints.sent') }}"
                    ...
                    <a href="{{ route('gestionnaire.reports.sent') }}"
                       style="display:inline-flex; align-items:center; justify-content:center; line-height:1.1; min-height:42px; padding:0.55rem 0.9rem; border:2px solid #193948; border-radius:10px; text-decoration:none; color:#193948; font-weight:700; background:#fff; box-shadow:0 4px 10px rgba(25,57,72,0.16); transition:all 0.2s ease;"
                       onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 8px 18px rgba(25,57,72,0.24)'; this.style.background='#f9f9f9';"
                    ...
                    @forelse($items as $item)
                        <tr style="background:{{ $loop->odd ? '#fff' : '#f8f8f8' }};">
                            ...
                            <td style="padding:0.7rem;">
                                <a href="{{ route('gestionnaire.complaints.show', $item->id) }}" style="display:inline-block; padding:0.3rem 0.6rem; border-radius:0.45rem; text-decoration:none; background:#193948; color:#4FADC0; font-weight:700;">Open</a>
                            </td>
                        </tr>
                    @empty
