<x-allthepages-layout pageTitle="Sent Messages">
    <div style="padding: 5px; margin: 5px;">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px; margin-bottom: 2rem;">
            <div>
                <h1 style="color: #193948; font-size: 2rem; font-weight: 700; margin: 0;">📤 Sent Messages</h1>
        ...
        @empty
            <div class="page-container" style="text-align: center; padding: 4rem;">
                ...
                <a href="{{ route('artist.messages.create') }}" style="padding: 12px 24px; background-color: #193948; color: #4FADC0; border-radius: 0.5rem; text-decoration: none; font-weight: 600;">
