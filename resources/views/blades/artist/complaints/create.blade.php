        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <div class="form-title-section">
                    ...
                    <p>أبلغ عن مشكلة أو مخالفة</p>
                </div>
            </div>
            
            <form action="{{ route('artist.store-complaint') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('artist.complaints.index') }}" class="btn-secondary">
                        إلغاء
                    </a>
                </div>
            </form>
