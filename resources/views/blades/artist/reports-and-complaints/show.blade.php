        ...
        <div class="rounded-lg shadow-lg p-6" style="background-color: #F3EBDD; border: 3px solid #193948; max-width: 900px; margin: 0 auto;">
            <div class="mb-6">
                <div class="flex flex-wrap items-start justify-between gap-4 mb-4">
                    <div>
                        <h2 class="text-2xl font-bold" style="color: #193948;">{{ $complaint->subject }}</h2>
            ...
            @if($complaint->images && count($complaint->images) > 0)
                <div class="mb-6">
                    ...
                    @include('blades.partials.complaint-gallery', [
                        'galleryId' => 'artist-complaint-'.$complaint->id,
                ...
                <div class="mb-6 pt-6" style="border-top: 2px solid rgba(25, 57, 72, 0.2);">
                    ...
                    @if(is_array($complaint->{$targetResponseImagesField}) && count($complaint->{$targetResponseImagesField}) > 0)
                        <div class="mt-3">
                            ...
                            @include('blades.partials.complaint-gallery', [
                                'galleryId' => 'artist-target-response-'.$complaint->id,
            ...
            <div class="mt-6">
                <a href="{{ route('artist.complaints.index') }}" class="inline-block px-4 py-2 rounded font-semibold" style="background-color: #193948; color: #4FADC0; text-decoration: none;">
                    ← Back to Complaints
                </a>
            </div>
        </div>
