<x-allthepages-layout pageTitle="Pending Artworks">
    <div style="padding: 5px; margin: 5px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 10px; padding: 5px;">
            <h1 style="color: var(--color-secondary-button); font-size: 1.5rem; font-weight: 700;">Artworks Awaiting Approval</h1>
        ...
        <div style="background-color: #F3EBDD; border-radius: 1rem; margin: 5px; padding: 5px; overflow-x: auto;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" style="color: #193948; padding: 2rem; text-align: center;">No pending artworks found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
