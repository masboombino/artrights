<x-allthepages-layout pageTitle="All Artworks">
    <div style="padding: 5px; margin: 5px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; flex-wrap: wrap; gap: 10px; padding: 5px;">
            <h1 style="color: var(--color-secondary-button); font-size: 1.5rem; font-weight: 700;">All Artworks You Uploaded</h1>
                    ...
                    @forelse($artworks as $artwork)
                        <tr style="border-top: 1px solid rgba(255, 227, 227, 0.1);">
                            ...
                            <td style="color: #193948; padding: 1rem; text-align: center;">
                                ...
                                @else
                                    <span style="background-color: #E76268; color: white; padding: 0.25rem 0.75rem; border-radius: 0.5rem; font-size: 0.8rem; font-weight: 600;">
                                        REJECTED
                                    </span>
                                @endif
                            </td>
