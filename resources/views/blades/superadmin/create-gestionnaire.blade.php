<x-allthepages-layout pageTitle="Create New Gestionnaire">
    <div class="max-w-2xl mx-auto">
        <div class="rounded-lg shadow p-6" style="background-color: #F3EBDD;">
            <form action="{{ route('superadmin.store-gestionnaire') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    <label for="agency_id" class="block text-sm font-medium mb-2" style="color: #193948;">Agency *</label>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('superadmin.manage-gestionnaires') }}" class="rounded transition hover:opacity-90" style="background-color: #193948; color: #4FADC0; padding: 1rem 2rem; text-decoration: none; font-weight: 600;">
