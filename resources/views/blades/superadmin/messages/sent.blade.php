<x-allthepages-layout pageTitle="Sent Messages">
    <div style="padding: 5px; margin: 5px;">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px; margin-bottom: 2rem;">
            <div>
                <h1 style="color: #F3EBDD; font-size: 2rem; font-weight: 700; margin: 0;">📤 Sent Messages</h1>
                <p style="color: #F3EBDD; font-size: 0.9rem; margin-top: 0.5rem; opacity: 0.8;">Messages you sent</p>
            </div>
            <a href="{{ route('superadmin.messages.index') }}" style="padding: 10px 20px; background-color: #193948; color: #4FADC0; border-radius: 0.5rem; text-decoration: none; font-weight: 600;">
                ← Back to Messages
            </a>
        </div>
        ...
        @forelse($items as $item)
            <div class="page-container" style="margin-bottom: 1.5rem; border-left: 4px solid {{ $item->type === 'COMPLAINT' ? '#E76268' : '#10b981' }};">
                <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 15px; margin-bottom: 1rem;">
                    ...
                    <a href="{{ route('superadmin.messages.show', $item->id) }}" style="padding: 8px 16px; background-color: #193948; color: #4FADC0; border-radius: 0.5rem; text-decoration: none; font-weight: 600; font-size: 0.9rem;">
                        View Details
                    </a>
                </div>
        ...
        @empty
            <div class="page-container" style="text-align: center; padding: 4rem;">
                ...
                <a href="{{ route('superadmin.messages.create') }}" style="padding: 12px 24px; background-color: #193948; color: #4FADC0; border-radius: 0.5rem; text-decoration: none; font-weight: 600;">
