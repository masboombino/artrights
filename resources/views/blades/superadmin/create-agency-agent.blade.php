<x-allthepages-layout pageTitle="Create Agent">
    <div class="space-y-6">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold" style="color: #D6BFBF;">Create Agent for {{ $agency->agency_name }}</h1>
        ...
        <div class="rounded-lg shadow-lg p-6" style="background-color: #F3EBDD; border: 3px solid #193948;">
            <form action="{{ route('superadmin.store-agency-agent', $agency->id) }}" method="POST">
                @csrf
