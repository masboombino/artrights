...
<body>
    ...
    <div class="header">
        <h1>Inspection Report (PV) #{{ $pv->id }}</h1>
    ...
    <div class="section">
        ...
        @if($pv->mission)
        <div class="info-row">
            <span class="info-label">Associated Mission:</span>
            <span class="info-value">{{ $pv->mission->title }}</span>
        </div>
        @endif
    </div>
    ...
    <div class="section">
        ...
        @if($pv->agent_confirmed_at)
        <div class="info-row">
            <span class="info-label">Confirmation Date:</span>
            <span class="info-value">{{ $pv->agent_confirmed_at->format('d/m/Y H:i') }}</span>
        </div>
        @endif
        @endif
        ...
        <div class="info-row">
            ...
            <span class="info-value"><strong>{{ $photoCount }} photos</strong></span>
        </div>
    ...
    @if($pv->closed_at)
    <div class="section">
        <div class="section-title">Closure Information</div>
        <div class="info-row">
            <span class="info-label">Closed At:</span>
            <span class="info-value">{{ $pv->closed_at->format('d/m/Y H:i') }}</span>
        </div>
    </div>
    @endif
