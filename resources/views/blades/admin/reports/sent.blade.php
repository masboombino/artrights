<x-allthepages-layout pageTitle="Reports Sent">
    <div style="padding: 1rem;">
        <div class="stat-card" style="padding: 1rem; margin-bottom: 1rem;">
            <h2 style="margin:0; color:#193948;">Reports Sent</h2>
            <p style="margin:0.4rem 0 0; color:#36454f;">Reports sent by admin.</p>
        </div>
        ...
        <div class="stat-card" style="padding:0; overflow:hidden;">
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr style="background:{{ $loop->odd ? '#fff' : '#f8f8f8' }};">
                                    ...
                                    <td style="padding:0.8rem;">
                                        <a href="{{ route('admin.reports.show', $item->id) }}" style="padding:0.35rem 0.7rem; border-radius:10px; text-decoration:none; background:#193948; color:#4FADC0; font-weight:700;">Open</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            @else
                <div style="padding:1.5rem; text-align:center; color:#36454f;">No sent reports found.</div>
            @endif
        </div>
    </div>
