<x-allthepages-layout pageTitle="Create Agent">
    <div class="space-y-6">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold" style="color: #D6BFBF;">Create Agent</h1>
            <a href="{{ route('admin.manage-agents') }}" class="rounded transition hover:opacity-90" style="background-color: #D6BFBF; color: #193948; padding: 0.75rem 1.5rem;">
                <span>Back</span>
            </a>
        </div>
        ...
        <div class="rounded-lg shadow-lg p-6" style="background-color: #F3EBDD; border: 3px solid #193948;">
            <form action="{{ route('admin.store-agent') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="badge_number" class="block text-sm font-medium mb-2" style="color: #193948;">Badge Number (Optional)</label>
                        <input type="text" name="badge_number" id="badge_number" value="{{ old('badge_number') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            style="background-color: white; color: #193948;">
                        <p class="mt-1 text-xs" style="color: #193948;">If left empty, a badge number will be auto-generated.</p>
                        @error('badge_number')
                            <p class="mt-1 text-sm" style="color: #E76268;">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex gap-4 mt-6">
                    ...
                    <a href="{{ route('admin.manage-agents') }}" class="rounded transition hover:opacity-90" style="background-color: #D6BFBF; color: #193948; padding: 0.75rem 1.5rem; text-decoration: none; font-weight: 600;">
                        <span>Cancel</span>
                    </a>
                </div>
            </form>
