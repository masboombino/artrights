        ...
        <div class="rounded-lg shadow-lg p-6" style="background-color: #F3EBDD; border: 3px solid #193948; border-radius: 20px;">
            ...
            <div class="mb-6">
                ...
                @if($complaint->complaint_type === 'ARTIST_TO_ADMIN')
                    <div class="mb-6">
                        ...
                        <form method="POST" action="{{ route('admin.assign-complaint', $complaint->id) }}" class="flex flex-col md:flex-row gap-3 items-start">
                            @csrf
            ...
            @else
                ...
                <div class="pt-6 border-t-2" style="border-color: rgba(255, 227, 227, 0.2);">
                    ...
                    <form action="{{ route('admin.respond-complaint', $complaint->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="{{ route('admin.manage-complaints') }}" class="rounded-lg shadow-lg transition hover:opacity-90" style="background-color: #36454f; color: #4FADC0; padding: 0.75rem 1.5rem; font-weight: 600;">
                                Back to List
                            </a>
                        </div>
                    </form>
