        ...
        <div class="rounded-lg shadow p-6" style="background-color: #F3EBDD;">
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div style="background-color: rgba(79, 173, 192, 0.1); border: 2px solid #193948; border-radius: 10px; padding: 1.5rem; margin-bottom: 1rem;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div>
                                ...
                                <div style="background-color: white; border: 1px solid #193948; border-radius: 5px; padding: 0.75rem; color: #193948; font-weight: 500;">
                                    {{ $user->agency ? $user->agency->agency_name : 'Not Assigned' }}
                                </div>
                            </div>
                            <div>
                                <label style="display: block; color: #193948; font-weight: 600; font-size: 0.9rem; margin-bottom: 0.5rem;">Wilaya (State)</label>
                                <div style="background-color: white; border: 1px solid #193948; border-radius: 5px; padding: 0.75rem; color: #193948; font-weight: 500;">
                                    {{ $user->agency ? $user->agency->wilaya : 'Not Assigned' }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="rounded transition hover:opacity-90" style="background-color: #193948; color: #4FADC0; padding: 1rem 2rem; text-decoration: none; font-weight: 600;">
